    ...
    <div className="animate-fade-in">
      ...
      {updates.length === 0 ? (
        <div className="card p-16 text-center">
          ...
          <p className="text-slate-500 text-sm max-w-sm mx-auto">Weekly updates from portfolio companies will appear here. Each update includes key support metrics and progress details.</p>
