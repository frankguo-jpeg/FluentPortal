...
export default async function LeaderboardPage() {
  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="card p-6 bg-gradient-to-r from-amber-50 to-yellow-50/50 border-amber-100/50 mb-6">
      ...
      {scores.length === 0 ? (
        <div className="card p-16 text-center">
          ...
          <h3 className="font-semibold text-slate-700 mb-1">No Monthly Scores Yet</h3>
          <p className="text-slate-500 text-sm max-w-sm mx-auto">Monthly scores are automatically computed from weekly AI-generated rankings. Submit weekly updates to start building your score.</p>
